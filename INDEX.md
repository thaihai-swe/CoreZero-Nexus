...
> Repo-level routing index for maintaining CoreZero Nexus itself.
...
| `kit/docs/rules/README.md` | Index of shipped Python and security rules. | When the active task touches language or security guidance. |
| `kit/manifest.json` | Installation manifest for the shipped package. | When auditing or changing what adopters receive. |
| `kit/HARNESS_CARD.md` | Harness summary for the shipped package. | Skim before non-trivial harness work. |
...
graph TD
    ...
    INDEX --> CARD["kit/HARNESS_CARD.md"]
