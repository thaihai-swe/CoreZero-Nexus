...
*   Constitution (`core-zero/memories/repo/core-policies.md`): Contains normative, repo-wide rules (the "musts"). Examples: Security guardrails, mandatory formatting rules, quality gates.
*   Knowledge Base (`core-zero/memories/repo/project-knowledge-base.md`): Contains descriptive facts (the "whats" and "hows"). Examples: Tech stack details, architecture boundaries, common conventions.
