...
2.  **Load Always Group:** Read every file in the `MASTER_INDEX.md` **Always** section. By default this is `core-policies.md` — it holds normative rules, canonical commands, and trust boundaries needed every session.
