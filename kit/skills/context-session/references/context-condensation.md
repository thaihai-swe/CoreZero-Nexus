...
| Budget Used | Threshold | Action |
|-------------|-----------|--------|
| < 50% | Green | No action |
| 50–64% | Yellow | Apply condensation strategies 1–3 (summarize, prune exploration, JIT loading). Log condensation action in progress.md. |
