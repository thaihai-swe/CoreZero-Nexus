...
- [`context-memory`](context-memory/SKILL.md) — Create, maintain, and route durable repository memory. Manages `INDEX.md`, the constitution, security policy, learned heuristics, the project knowledge base, and the post-ship knowledge sync after `harness-verify` passes.
