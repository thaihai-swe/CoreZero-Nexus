#!/bin/bash
# Batch Test Script
# Renders regression fixtures and validates SVGs
...
echo -e "${BLUE}=== CoreZero Nexus Visualize - SVG Regression Test ===${NC}"
...
for i in "${!STYLES[@]}"; do
    ...
    echo -e "   ${YELLOW}Style $STYLE: $STYLE_NAME${NC}"
...
PY
    ...
    # Render and validate each fixture
