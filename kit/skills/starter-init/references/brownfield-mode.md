...
4. **Brownfield map recommendation**: If the codebase is non-trivial (more than ~10 files or multiple subsystems), route the first feature through `spec-research` with `../../spec-research/references/brownfield-mapping-template.md` before any feature work begins.
