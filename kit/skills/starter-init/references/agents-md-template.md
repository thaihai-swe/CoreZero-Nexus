...
Adopters execute software delivery using the following commands. Route to the matching skill file for detailed workflows:

* `/starter-init` -> Boot harness config and seed memories. Skill: [skills/starter-init/SKILL.md](file:///skills/starter-init/SKILL.md)
* `/context-session` -> Start/checkpoint/end feature session boundaries. Skill: [skills/context-session/SKILL.md](file:///skills/context-session/SKILL.md)
* `/context-memory` -> Sweep, triage, and promote repository-wide memory. Skill: [skills/context-memory/SKILL.md](file:///skills/context-memory/SKILL.md)
* `/context-status` -> List features phase status and active claims. Skill: [skills/context-status/SKILL.md](file:///skills/context-status/SKILL.md)
* `/spec-research` -> Map legacy codebase boundaries and analyze symptoms. Skill: [skills/spec-research/SKILL.md](file:///skills/spec-research/SKILL.md)
* `/spec-requirements` -> Run grilling waves and lock requirements. Skill: [skills/spec-requirements/SKILL.md](file:///skills/spec-requirements/SKILL.md)
* `/spec-plan` -> Design technical approach and decompose tasks. Skill: [skills/spec-plan/SKILL.md](file:///skills/spec-plan/SKILL.md)
* `/spec-implement` -> Execute implementation tasks with proving evidence. Skill: [skills/spec-implement/SKILL.md](file:///skills/spec-implement/SKILL.md)
* `/spec-adr` -> Record architecture decision logs. Skill: [skills/spec-adr/SKILL.md](file:///skills/spec-adr/SKILL.md)
* `/harness-verify` -> Run mechanical tests, alignment, and security audits. Skill: [skills/harness-verify/SKILL.md](file:///skills/harness-verify/SKILL.md)
* `/harness-maintain` -> Assess, configure, and maintain the harness subsystems. Skill: [skills/harness-maintain/SKILL.md](file:///skills/harness-maintain/SKILL.md)
* `/code-review` -> Standalone or gated review of code changes. Skill: [skills/code-review/SKILL.md](file:///skills/code-review/SKILL.md)
* `/visualize` -> Generate architecture and sequence diagrams. Skill: [skills/visualize/SKILL.md](file:///skills/visualize/SKILL.md)
* `/codebase-documenter` -> Compile project orientation and onboarding READMEs. Skill: [skills/codebase-documenter/SKILL.md](file:///skills/codebase-documenter/SKILL.md)
* `/system-flow-docs` -> Trace multi-container flows and workflows. Skill: [skills/system-flow-docs/SKILL.md](file:///skills/system-flow-docs/SKILL.md)
* `/api-endpoint-docs` -> Document HTTP API endpoint contract specs. Skill: [skills/api-endpoint-docs/SKILL.md](file:///skills/api-endpoint-docs/SKILL.md)
